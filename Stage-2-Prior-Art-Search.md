...
This is Stage 2 of the Patent Analyzer system. Paste this prompt (along with all previous stage outputs from the handoff block) into a new conversation that has web search enabled. After the AI completes its search, copy the handoff block it produces and paste it into a new conversation to run Stage 3.

**IMPORTANT: This stage REQUIRES web search capability. Use a model/platform that supports web search.**
